...
cfg.cfginit('./Helpers/killcss.txt',init_server);
}
...
function init_fuzz(){
    ...
    retString += "<" + elem0 + " id='test0' style='"+ generateCss()+"'>\n";
    retString += "<" + elem1 + " id='test1' style='" +generateCss()+"'>\n";
    retString += "<" + elem2 + " id='test2' style='" +generateCss()+"'>\n";
    retString += "<" + elem3 + " id='test3' style='" +generateCss()+"'>\n";
    retString += "</" + elem3 +">\n"
    retString += "</" +elem2 + ">\n"
    retString += "</" +elem1 + ">\n"
    retString += "</" +elem0 + ">\n"
